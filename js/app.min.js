...
window.onload = function () {
	...
	function documentActions(e) {
		...
		if (window.innerWidth > 768 && isMobile.any()) {
			...
			if (targetElement.closest('.menu__sub-arrow')) {
				_removeClasses(document.querySelectorAll('.menu__sub-item--drop-down._hover'), '_hover');
				targetElement.closest('.menu__sub-item--drop-down').classList.add('_hover');
			}
			if (!targetElement.closest('.menu__sub-item--drop-down') && document.querySelectorAll('.menu__sub-item--drop-down._hover').length > 0) {
				_removeClasses(document.querySelectorAll('.menu__sub-item--drop-down._hover'), '_hover');
			}
		}
	}
	...
	let filterContainer = document.querySelector('.projects__list');
	let galleryItems = document.querySelectorAll('.projects__column');

	if (filterContainer && galleryItems) {
		filterContainer.addEventListener('click', (event) => {
			if (event.target.classList.contains('projects__btn')) {
...
let allSlides = document.querySelector('.home-silder ._fraction__all');
let allCurrentSlide = document.querySelector('.home-silder ._fraction__current');
const allSlidesCounter = document.querySelectorAll('.home-silder__slide').length;

if (document.querySelector('.home-silder__body')) {
	new Swiper('.home-silder__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		watchOverflow: true,
		...
		// // Dotts
		// pagination: {
		// 	el: '.home-silder__dots',
		// 	clickable: true,
		// },
		// Arrows
		navigation: {
			nextEl: '.home-silder__arrow--left',
			prevEl: '.home-silder__arrow--right',
		},
		on: {
			lazyImageReady: function () {
				ibg();
...
if (document.querySelector('.slider-design__body')) {
	new Swiper('.slider-design__body', {
		observer: true,
		observeParents: true,
		watchOverflow: true,
		speed: 800,
		...
		// Arrows
		navigation: {
			nextEl: '.slider-design__arrow--left',
			prevEl: '.slider-design__arrow--right',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.15,
...
if (document.querySelector('.review__body')) {
	new Swiper('.review__body', {
		observer: true,
		observeParents: true,
		watchOverflow: true,
		speed: 800,
		...
		// Arrows
		navigation: {
			nextEl: '.review__arrow--left',
			prevEl: '.review__arrow--right',
		},
		breakpoints: {
			320: {
				slidesPerView: 1.15,
